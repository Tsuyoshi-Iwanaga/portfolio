...
<div class="p-kv">
  <div class="l-contentInner l-kv_inner">
    <p class="p-kv_logo"><img src="<?php bloginfo('template_url'); ?>/images/img_kv_logo.png" alt=""></p>
...
<section class="l-contentSection -works" id="works">
  <div class="l-contentInner">
    <h2 class="c-sectionTitle js-fadeIn">WORKS</h2>
    <p class="c-middleTitle js-fadeIn">過去の経歴と実績 / 料金</p>
...
<section class="l-contentSection -service" id="service">
  <div class="l-contentInner">
    <h2 class="c-sectionTitle js-fadeIn">SERVICE</h2>
    <p class="c-middleTitle js-fadeIn">自社サービスとコンテンツ</p>
    <ul class="p-serviceList">
      <li class="p-serviceList_item js-fadeIn">
...
<section class="l-contentSection -blog" id="blog">
  <div class="l-contentInner">
    ...
    <p class="c-middleTitle js-fadeIn">アートディレクションとマーケティングの研究<br>ノート＆日々の雑記帳や考えまとめ。</p>
    <ul class="p-blogList">
    <?php
    ...
    <p class="c-more"><a href="/blog/" class="c-moreLink">MORE</a></p>
  </div>
</section><!-- /.l-blog -->
<section class="l-contentSection -company" id="company">
  <div class="l-contentInner">
    <h2 class="c-sectionTitle js-fadeIn">COMPANY</h2>
    <div class="p-contentBlock js-fadeIn">
      ...
      <p class="p-company_catch js-fadeIn">Where there is a will,<br>there is a way.</p>
    </div>
    <div class="p-contentBlock js-fadeIn">
      <div class="p-contentBlock_textArea">
